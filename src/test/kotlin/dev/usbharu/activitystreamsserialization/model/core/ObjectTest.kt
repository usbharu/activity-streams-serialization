...
class ObjectTest {
  ...
  "name": "A Simple, non-specific object"
        ...
        val objectOrNull = jsonLd.asTypeOfNull<dev.usbharu.activitystreamsserialization.model.core.Object>(Type.OBJECT)
    ...
    fun serializeObject() {
        val objects =
            DefaultObjectFactory.create<dev.usbharu.activitystreamsserialization.model.core.Object>(Type.OBJECT)
  ...
  "name": "A Simple, non-specific object"
    ...
    fun deserializeAttachment() {
        val checkDeserialize = checkDeserialize<dev.usbharu.activitystreamsserialization.model.core.Object>(
            """{
  "@context": "https://www.w3.org/ns/activitystreams",
  "type": "Object",
  "attachment": [
  ...
  "attachment": [
    ...
    fun deserializeAttributedTo1() {
        val deserialize = checkDeserialize<dev.usbharu.activitystreamsserialization.model.core.Object>(
            """{
  "@context": "https://www.w3.org/ns/activitystreams",
  "type": "Object",
  "attributedTo": [
